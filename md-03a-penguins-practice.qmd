...
```{r}
penguins |>
  filter(sex == "female", species == "Chinstrap", island %in% c("Dream", "Torgerson"))
```
...
```{r}
penguins |> 
  filter(island %in% c("Torgerson","Biscoe"), sex == "female")

penguins |>
  count(sex == "female"& island == "Torgerson" |sex == "female"& island == "Biscoe" )
```
